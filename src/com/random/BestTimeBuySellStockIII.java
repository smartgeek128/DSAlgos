 ...
 * 
 * sell1 means we decide to sell the stock, after selling it we have price[i] money and we have 
 * to give back the money we owed, so we have price[i] - |buy1| = prices[i ] + buy1, we want to make this max.
 * 
